...
public class AddIncomeDb extends AppCompatActivity {
    ...
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("http://10.0.2.2:80/expenses/android/insert_income_db_android.php"); // here is your URL path
