 ...
 * {@link ExpensesWebView.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ExpensesWebView#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ExpensesWebView extends Fragment {
     ...
     * @return A new instance of fragment ExpensesWebView.
     */
    // TODO: Rename and change types and number of parameters
    public static ExpensesWebView newInstance(String param1, String param2) {
        ExpensesWebView fragment = new ExpensesWebView();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pieView = inflater.inflate(R.layout.fragment_expenses_web_view, container, false);
    ...
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            WebView pieChart = (WebView) pieView.findViewById(R.id.expensesPieChart);

            try{

                pieChart.getSettings().setJavaScriptEnabled(true);
                String postData = "username=" + URLEncoder.encode(Variables.username, "UTF-8");
                pieChart.postUrl(Variables.servername+"android/expenses_pie_chart_android.php", postData.getBytes());
                //TextView a = (TextView) pieView.findViewById(R.id.textView4);
